...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance = 1cm, auto]
        ...
        \node [block, right of=start, node distance=3cm] (init) {Init von Temperatur/Prompt};
		\node [block, right of=init, node distance=3cm] (get) {Erfasse Java-Dateien im Projekt};
