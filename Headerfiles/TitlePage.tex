...
\includegraphics[width=4.74cm]{Assets/Pictures/logos/HTWK-Fakultaetszusatz_IM_schwarz_de-eps-converted-to.pdf}
\end{textblock*}
\begin{center}
...
\includegraphics[width=8.41cm]{Assets/Pictures/logos/htwk-logo-eps-converted-to.pdf}
\end{textblock*}
